...
public class JiuzhenxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiuzhenxinxiEntity jiuzhenxinxi,
		...
		if(tableName.equals("yisheng")) {
			jiuzhenxinxi.setYishenggonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			jiuzhenxinxi.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
