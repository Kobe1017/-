<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="就诊编号" prop="jiuzhenbianhao">
					<el-input v-model="ruleForm.jiuzhenbianhao" placeholder="就诊编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.jiuzhenbianhao" label="就诊编号" prop="jiuzhenbianhao">
					<el-input v-model="ruleForm.jiuzhenbianhao" placeholder="就诊编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="科室分类" prop="keshifenlei">
					<el-input  v-model="ruleForm.keshifenlei" placeholder="科室分类" clearable  :readonly="ro.keshifenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="科室分类" prop="keshifenlei">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="科室位置" prop="keshiweizhi">
					<el-input  v-model="ruleForm.keshiweizhi" placeholder="科室位置" clearable  :readonly="ro.keshiweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="科室位置" prop="keshiweizhi">
					<el-input v-model="ruleForm.keshiweizhi" placeholder="科室位置" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="预约时间" prop="yuyueshijian">
					<el-input  v-model="ruleForm.yuyueshijian" placeholder="预约时间" clearable  :readonly="ro.yuyueshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="预约时间" prop="yuyueshijian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="就诊时间" prop="jiuzhenshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.jiuzhenshijian" label="就诊时间" prop="jiuzhenshijian">
					<el-input v-model="ruleForm.jiuzhenshijian" placeholder="就诊时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="就诊详情" prop="jiuzhenxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.jiuzhenxiangqing" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.jiuzhenxiangqing" label="就诊详情" prop="jiuzhenxiangqing">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiuzhenxiangqing"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='jiuzhenbianhao'){
							this.ruleForm.jiuzhenbianhao = obj[o];
							this.ro.jiuzhenbianhao = true;
							continue;
						}
						if(o=='keshimingcheng'){
						...
						if(o=='jiuzhenxiangqing'){
							this.ruleForm.jiuzhenxiangqing = obj[o];
							this.ro.jiuzhenxiangqing = true;
							continue;
						}
						if(o=='crossuserid'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiuzhenxiangqing = this.ruleForm.jiuzhenxiangqing.replace(reg,'../../../springboot8jjp4y66/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.jiuzhenbianhao) {
			this.ruleForm.jiuzhenbianhao = String(this.ruleForm.jiuzhenbianhao)
		}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiuzhenxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiuzhenxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
